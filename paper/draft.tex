...
%% Hurlbert
% !! Hypothesis: Quick establishment of reproductive barriers (+ population variability) facilitates/speeds up adaptation. !!
...
Island radiations like the classical Darwin finches on Galápagos or \textit{Aeonium} on the Canaries have fascinated researchers throughout history. %% Maybe other examples?
But why were these genera able to produce this multitude of species as opposed to most other genera that remain species poor?
...
(b) have reproductive barriers (e.g. environmental/geographical, ecological or behavioral) that facilitate establishment of distinct distribution patterns of said characteristic.
...
In fact, these factors indeed often correlate strongly with the timing of genetic divergence of species and populations. % REFS!
...
Yet, only a fraction of them manage to radiate into multiple species through the course of their evolutionary history.
...
Genetic analyses have already helped clearing up phylogenies of many species groups %, like bats or cichlids REFS!
and more and more complete genomes are published on a regular basis.
Some of these studies highlight the importance of genetic linkage or ``hitchhiking'' on reproductive/ecological isolation of populations \cite{hawthorneGeneticLinkageEcological2001}\cite{viaGeneticMosaicSuggests2008}%(e.g., Via \& West 2008, Via 2001 and references therein)
...
we present a mechanistic model that overcomes above-mentioned shortcomings of missing micro-evolutinary processes and lack of integrative design %(LIST THEM HERE IN SHORT)
