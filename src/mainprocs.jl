...
# XXX Not needed for invasion experiments
...
"""
    invade!(w, p)
Individuals from the global species pool are deposited on the island.
"""
function invade!(world::Array{Patch,1}, settings)
