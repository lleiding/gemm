...
However, it is often unclear why these genera produced this multitude of species as opposed to most other genera that remained species poor.
To explain speed and occurences of radiations, researchers still mainly focus on environmental and ecological factors \cite{krugSpeciesGenusRatios2008}\cite{hurlbertProcessesGeneratingLatitudinal2014}\cite{willisSpeciesDiversityScale2002}. % when radiations DID happen!
While these factors often correlate strongly with genetic divergence of species and populations, % REFS!
in some cases the reason for maintenance of population diversity remains in the dark. \cite{chenConcordanceGeneticDiversity}
...
their effect on population variability. %EXAMPLES
