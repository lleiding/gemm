...
const mortality = exp(22.0) # global base mortality from Brown et al. 2004 is 26.3, but competition and dispersal introduce add. mort.
const fertility = exp(28.0) # global base reproduction rate 23.8 from Brown et al. 2004, alternatively 25.0
            ...
            if currentmass >= patch.community[idx].traits["repsize"]
                ...
                if length(posspartners) > 0
                    ...
                    for i in 1:noffs # pmap? this loop could be factorized!
                        println("reproduction by ", patch.community[idx].lineage, ": ", noffs)
