...
const fertility = exp(26.5) # global base reproduction rate 23.8 from Brown et al. 2004, alternatively 25.0, default 30.0
const phylconstr = 10 #parse(ARGS[2])
# const meangenes = 20 # mean number of genes per individual
const mutationrate = 1e8 # one mutation per generation with 20bp genes, corrected for metabolic function
